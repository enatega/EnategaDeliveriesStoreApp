const en = {
  ...
  profile_instant_delivery: "Instant Delivery",
  profile_instant_delivery_subtitle: "Enable instant delivery or set delivery time in days",
  profile_instant_delivery_on: "Enabled",
  profile_instant_delivery_off: "Set days",
  profile_instant_delivery_days_label: "Delivery time in days",
  profile_instant_delivery_days_placeholder: "Enter number of days",
  profile_instant_delivery_days_error: "Enter a valid number of days",
  ...
  order_print_invoice: "Print Invoice",
  printer_title: "Invoice Printer",
  printer_searching: "Searching for printers...",
  printer_printing: "Printing invoice...",
  printer_no_devices: "No paired Bluetooth printers found.",
  printer_scan_again: "Scan Again",
  printer_cancel: "Cancel",
  printer_open_settings: "Open Settings",
  printer_permission_denied: "Bluetooth permission is required to print invoices.",
  printer_scan_failed: "Unable to scan for printers. Check Bluetooth and try again.",
  printer_connect_failed: "Unable to connect to this printer.",
  printer_print_failed: "Unable to print the invoice. Check the printer and try again.",
  printer_success_title: "Printed",
  printer_success_message: "Invoice printed successfully.",
